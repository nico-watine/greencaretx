...
<head>
	...
	<link href="https://greencaretx.com/project-galleries" rel="canonical">
...
<main id="project-galleries">
	<div class="main-content-mobile main-content row">
		<div id="page-title">
			<div class="h1-wrap" id="project-galleries">
				<h1 class="vertical-title">project galleries</h1>
			</div>
		</div>
		<div id="page-content">
			<section class="page-header">
				<div class="row">
					...
					<h3>Here are some of our recent projects.</h3>
					<h3>Whatever style you may be looking for, we have the design to match your vision.</h3>
				</div>
			</section>
			<section class="project-galleries-gallery">
