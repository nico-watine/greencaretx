...
<main id="contact">
	<div class="main-content-mobile main-content row">
		<div id="page-title">
			<div class="h1-wrap" id="contact">
				<h1 class="vertical-title">contact</h1>
			</div>
		</div>
		<div id="page-content">
			<section class="page-header" id="contact">
				<div class="row">
					<h1>Contact</h1>
					<h3>We hope to hear from you! Here’s how to get in touch.</h3>
				</div>
			</section>
			...
			<hr>
			<div class="row" id="plant-purchases">
				<section class="purchase-options">
					...
					<div class="row" id="jdf">
						<div class="logo">
							<a href="http://www.jardindefrancetx.com" target="_blank"><img src="/img/contact/jardin-de-france-logo.jpg" alt="Jardin de France Logo"></a>
						</div>
						<div class="verbiage">
...
<footer>
	...
	<div id="contact-info">
		...
		<h4 id="contact-us">request a free quote at <a href="tel://713-864-5300" class="phone-number">713-864-5300</a> <span>or <a href="#">contact us</a></span></h4>
	</div>
</footer>
